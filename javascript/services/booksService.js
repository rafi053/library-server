...
import { readFromJsonFile, writeToJsonFile, writeUsersToJsonFile, } from "../dal/access.js";
...
export const deleteBookFromDB = (userId, bookId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const index = users.findIndex((i) => i.id === userFind.id);
    books.splice(index, 1);
    yield writeToJsonFile(userFind);
});
